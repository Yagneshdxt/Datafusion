...
(function($){
    ...
    $(document).ready(function() {
        ...
        $('#submit').click(function(){
            ...
            if($('#feedback-form #name').val() == '' || $('#feedback-form #email').val() == "" || $('#feedback-form #message').val() == ""){
                $('#feedback-form #success').html("Please provide required details.");
            }else{
               var rx = /^[\w\.-]+@[\w\.-]+\.\w+$/i;
			   if(rx.test($('#feedback-form #email').val())){
                    setTimeout(function(){ $('#feedback-form #success').html("Feedback received successfully.") }, 3000);
               }else{
               $('#feedback-form #success').html("Incorrect details detected.");
               }
            }
            ...
            $.ajax({
                type: "POST",
                url: Metrika_Ajax.site_url + "/admin/admin-ajax.php",
                data: data,
